...
- Enabling configuration-editing tools and disabling configuration credential filtering each require a local confirmation. Returning either setting to its safer state does not prompt.
